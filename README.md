...
- `createAsyncThunk('AT', asyn)` dispatches actions for each of the promise lifecycle STATES - pending, fulfilled, rejected

      PASSING ACTION TYPE STRING - 'resource/actionType' to createAsyncThunk
      `createAsyncThunk('resourceType/actionType', ASYNC)`--> dispatched ACTION TYPES
