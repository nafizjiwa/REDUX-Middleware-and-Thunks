...
- createSlice( ) generates a slice of the store that responds to an action creator:
     - `usersSlice.actions.addUser`
- What happens to action types generated by `createAsyncThunk( )` action creators
